  ...
  return (
    <TooltipProvider delayDuration={100}>
      <motion.aside
        ...
        className="fixed left-0 top-0 bottom-0 z-40 flex flex-col border-r border-border bg-card/60 backdrop-blur-sm"
      >
        {/* Logo */}
        <div
          className={cn(
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    collapsed ? 'justify-center h-9 w-9 mx-auto' : 'h-9 gap-3 px-2.5',
                    isActive
